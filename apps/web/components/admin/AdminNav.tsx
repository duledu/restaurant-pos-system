...
const RecipeIcon = () => icon("M4 19.5A2.5 2.5 0 0 1 6.5 17H20 M6.5 2H20v20H6.5A2.5 2.5 0 0 1 4 19.5v-15A2.5 2.5 0 0 1 6.5 2Z M9 7h7 M9 11h7 M9 15h4");
const CountIcon = () => icon("M9 11l3 3L22 4 M21 12v7a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h11");
const TablesIcon = () => (
  <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={1.8} strokeLinecap="round" strokeLinejoin="round" aria-hidden="true">
...
const NAV_SECTIONS: NavSection[] = [
  {
    ...
    items: [
      ...
      { href: "/inventura", label: "Inventura", icon: <CountIcon /> },
